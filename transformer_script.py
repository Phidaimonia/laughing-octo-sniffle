...
exp_name = "test_transformer_supervised"
...
# Encoder
x = TransformerBlock(embed_dim, 4, embed_dim*2, rate=0.05)(x)
x = TransformerBlock(embed_dim, 4, embed_dim*2, rate=0.05)(x)
x = TransformerBlock(embed_dim, 4, embed_dim*2, rate=0.05)(x)
x = TransformerBlock(embed_dim, 4, embed_dim*2, rate=0.05)(x)

x = Dense(64, activation = 'linear', kernel_constraint=max_norm(10.0), bias_constraint=max_norm(10.0))(x)
